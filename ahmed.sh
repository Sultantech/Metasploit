...
echo " ~ Written By Sultan Ahmed - Sultan Tech"
echo " ~ Facebook: meersultan143"
echo " ~ YouTube: Sultan Tech"
echo " ~ GitHub: Sultantech"
echo
echo "${green}${bt}"
...
if [[ $verName == 1 ]]; then
     ...
     if [[ -f $loc ]]; then
          ...
          echo " ~ Type msfconsole To Run"
          echo " ~ Subscribe My YouTube Channel"
          echo " ~ Link: https://tiny.cc/R9VyChbFnX3u06vnbHl6pg"
          xdg-open https://youtube.com/UCR9VyChbFnX3u06vnbHl6pg
     else
          echo
          echo " ~ Fialed To Install Metasploit"
          echo
